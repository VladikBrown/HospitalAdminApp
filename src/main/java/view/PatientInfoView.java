...
public class PatientInfoView extends GridPane implements IView {
    Presenter presenter;
    ...
    public PatientInfoView(){
        congigureGridPaneConstraints();
    }

    public PatientInfoView(Presenter presenter){
        this.presenter = presenter;
        congigureGridPaneConstraints();
    }

    public void congigureGridPaneConstraints(){
